...
public class WebAuthnController {
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> finishAuthentication(@RequestBody String request) {
        try {
            ...
            if (result.isSuccess()) {
                User user = userService.findByUsername(result.getUsername())
    ...
    public PublicKeyCredentialCreationOptions startRegistration(@RequestBody RegistrationOptionsRequest request) {
        ...
        return webAuthnService.startRegistration(username, displayName);
    }
